...
This directory bundles some self‑contained examples using OpenCodex. If you have never used OpenCodex before, and want to see it complete a sample task, start with running **camerascii**. You'll see your webcam feed turned into animated ASCII art in a few minutes.

If you want to get started using OpenCodex directly, skip this and refer to the prompting guide.
...
├── task.yaml        # task spec containing a prompt passed to OpenCodex
...
**template/**: any existing files or markdown instructions you would like OpenCodex to see before it starts working.
...
- **impossible‑pong**: where OpenCodex creates more difficult levels.
