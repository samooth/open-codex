...
import { getModelPricing, MODEL_PRICING, resetCachedPricing } from '../src/utils/model-pricing';
...
describe('getModelPricing', () => {
  ...
  it('should prioritize the longest matching key', () => {
    ...
    expect(getModelPricing('gpt-4-turbo-preview')).toEqual(MODEL_PRICING['gpt-4-turbo']);
  });
  ...
  it('should load and use user-defined pricing from the config file', () => {
    ...
    expect(getModelPricing('custom-model')).toEqual(userPricing['custom-model']);
