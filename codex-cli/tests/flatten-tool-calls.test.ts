...
describe("flattenToolCalls", () => {
  it("splits concatenated JSON objects in tool call arguments", () => {
    const toolCalls: Array<ChatCompletionMessageToolCall> = [
      {
        ...
        function: {
          ...
          arguments:
            '{"end_line":3,"path":"file1.md","start_line":1}{"end_line":3,"path":"file2.md","start_line":1}',
        },
      },
    ];
    ...
    expect(JSON.parse((flattened[0] as any).function.arguments).path).toBe(
      "file1.md",
    );
    expect((flattened[1] as any).function.name).toBe("read_file_lines");
    expect(JSON.parse((flattened[1] as any).function.arguments).path).toBe(
      "file2.md",
    );
  });
  ...
  it("should handle three concatenated JSON objects for different files", () => {
    const toolCalls: Array<ChatCompletionMessageToolCall> = [
      {
        ...
        function: {
          name: "read_file",
          arguments:
            '{"path":"package.json"}{"path":"src/pages/landing.html"}{"path":"src/css/landing.css"}',
        },
      },
    ];
    ...
    expect(JSON.parse((flattened[2] as any).function.arguments).path).toBe(
      "src/css/landing.css",
    );
  });
});
