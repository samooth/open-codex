...
export const recipes: Array<Recipe> = [
  {
    ...
    description:
      "Acts as a senior fullstack developer, proficient in frontend, backend, databases, and DevOps.",
    prompt: `
...
`,
  },
  {
    ...
    prompt:
      "Generate comprehensive unit tests for the current file or specified path. Use the existing testing framework and style guidelines. Ensure edge cases are covered.",
  },
  {
    name: "Documentation Writer",
    description: "Adds JSDoc/TSDoc comments and high-level documentation.",
    prompt:
      "Analyze the code and add clear, concise TSDoc/JSDoc comments to all public functions and classes. Also, generate or update a README.md section explaining this module's purpose and usage.",
  },
  {
    name: "Security Auditor",
    description:
      "Scans for common security vulnerabilities and best practice violations.",
    prompt:
      "Perform a security audit of this module. Look for common vulnerabilities (e.g., injection, insecure dependencies, sensitive data leaks). Use the snyk_search tool to check for known vulnerabilities in the used libraries and suggest mitigations following best practices.",
  },
  {
    name: "Refactor Expert",
    description:
      "Suggests architectural improvements and cleans up code smells.",
    prompt:
      "Review the code for smells, redundancy, and architectural issues. Propose and implement a refactored version that improves readability, maintainability, and follows SOLID principles.",
  },
  {
    name: "Bug Hunter",
    description: "Identifies potential logic bugs and edge case failures.",
    prompt:
      "Deeply analyze the logic of this component. Identify potential bugs, race conditions, or edge cases that are not currently handled. Propose fixes for each issue found.",
  },
  {
    name: "Performance Optimizer",
    description: "Identifies bottlenecks and suggests faster alternatives.",
    prompt:
      "Profile the code mentally and identify potential performance bottlenecks. Suggest and implement optimizations to reduce execution time and memory usage.",
  },
  {
    name: "Dependency Auditor",
    description: "Checks for outdated npm dependencies and suggests updates.",
    prompt:
      "Scan the package.json file. Use the npm_search tool to check for the latest versions of all dependencies and suggest updates where appropriate.",
  },
  {
    name: "Vulnerability Scanner (Snyk)",
    description:
      "Uses Snyk to find known vulnerabilities in your project dependencies.",
    prompt:
      "Identify all top-level dependencies in this project. For each major dependency, use the snyk_search tool to check for known security vulnerabilities and provide a summary report with mitigation advice.",
  },
  {
    name: "TypeScript Converter",
    description:
      "Converts a JavaScript file to TypeScript, adding types and interfaces.",
    prompt:
      "Read the specified JavaScript file. Convert it to TypeScript by adding appropriate types to variables, function parameters, and return values. Where complex objects are used, generate and apply corresponding interfaces. Ensure the converted code is type-safe.",
  },
  {
    name: "CI/CD Pipeline Starter",
    description: "Generates a starter GitHub Actions workflow for the project.",
    prompt:
      "Analyze the `package.json` scripts and project structure. Generate a starter `main.yml` file for GitHub Actions that installs dependencies, runs the linter, executes the test suite, and runs the build command on every push to the `main` branch.",
  },
  {
    name: "API Documentation Writer",
    description: "Creates OpenAPI (Swagger) documentation for an API file.",
    prompt:
      "Analyze the provided API route file (e.g., an Express router). Generate an OpenAPI 3.0 specification in YAML format that documents each endpoint. Include paths, methods, parameters (path, query, body), and example responses based on the code.",
  },
  {
    name: "Feature Scaffolder",
    description:
      "Scaffolds a new feature (component, route, service, and test) based on your description.",
    prompt:
      "Analyze the current project structure and patterns. Scaffold a new feature based on the user's description. Create all necessary files (e.g., UI components, API routes, services, and unit tests) following existing naming conventions and directory layouts. Ensure the feature is properly integrated and exported.",
  },
  {
    name: "Accessibility (a11y) Expert",
    description:
      "Reviews components for WCAG compliance, adding ARIA labels and keyboard support.",
    prompt:
  ...
  },
  {
    ...
    description:
      "Analyzes project structure and proposes high-level architectural improvements.",
    prompt:
  ...
  },
  {
    ...
    description:
      "Analyzes log files or error outputs to find root causes and propose fixes.",
    prompt:
      "Read the provided error logs or terminal output. Identify the root cause of the failure by searching the codebase for relevant files and symbols. Propose and implement a fix that addresses the issue and prevents it from recurring. Include a regression test if possible.",
  },
  {
    name: "Context Optimizer",
    description:
      "Suggests which files are most important to 'pin' for the current task.",
    prompt:
      "Based on the user's current goal, analyze the codebase to identify the most critical 'source of truth' files (interfaces, core logic, config). Propose a list of files to `/pin` to the context window to maximize reasoning efficiency while staying within token limits.",
  },
  {
  ...
  },
  {
    name: "PR Preparer",
    description:
      "Generates a clean commit message and PR description for your changes.",
    prompt:
      "Review all changes made in the current session using `git diff`. Generate a professional, concise PR description including a 'Why' (rationale), 'What' (high-level changes), and a 'How to Test' section. Also, propose a standard-compliant commit message following the Conventional Commits specification.",
  },
];
