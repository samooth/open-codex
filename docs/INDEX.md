...
- [CLI_ROADMAP.md](./CLI_ROADMAP.md): Technical roadmap for the CLI package.
...
- [MCP.md](./MCP.md): Guide for using the Model Context Protocol (MCP) to extend Open Codex capabilities.
...
- [NEW_IMPROVEMENTS.md](./NEW_IMPROVEMENTS.md): Detailed status of recent UI/UX enhancements.
- [CI.md](./CI.md): Continuous Integration setup and best practices.
- [CLI_CI.md](./CLI_CI.md): CI configuration specific to the CLI package.
