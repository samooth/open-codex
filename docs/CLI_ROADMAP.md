...
- **[DONE] True Multi-line Support:** Integrated `MultilineTextEditor` into the main chat input with `Shift+Enter`, `Ctrl+J`, and `Alt+Enter` for newlines and `Ctrl+Enter` for submission.
